...
//#include "Game.h" // Server is the Games-Handler, of course it includes Games.
...
//decided to remove so we dont tie our implementation too closely to specific games
// enum GameType {
//   RockPaperScissors,
//   Unknown
// }
...
// Adding a declaration for game code function defined in Server.cpp
std::string generateRandomCode();
bool isValidGameCode(std::string);
